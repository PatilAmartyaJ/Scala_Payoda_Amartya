    ...
    Behaviors.receive { (ctx, msg) =>
      msg match {
        ...
        case ProcessBookingEvent(eventJson) =>
          ...
          roomprepService ! RoomPreparationActor.SendRoomPreperationEmail("ajpatil_b19@it.vjti.ac.in", "Amartya Patil", roomName = roomName, roomLocation = roomLocation, startTime = startTime)
